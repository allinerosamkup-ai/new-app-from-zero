        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <div style={{ position: "relative" }}>
            <div style={{ width: "100%", height: 8, background: "rgba(99,152,169,.15)", borderRadius: 999, overflow: "visible", position: "relative" }}>
              <div style={{ width: `${horasPct}%`, height: "100%", borderRadius: 999, background: "linear-gradient(90deg, var(--lagune), var(--menthe))" }} />
              <div style={{ width: 20, height: 20, background: "#fff", border: "2px solid var(--lagune)", borderRadius: "50%", position: "absolute", top: "50%", left: `${horasPct}%`, transform: "translate(-50%, -50%)", boxShadow: "0 2px 8px rgba(99,152,169,.25)", pointerEvents: "none" }} />
            </div>
          ...
          {QUALITY_CARDS.map(c => {
            ...
            return (
              ...
              >
                ...
                <p style={{ fontSize: 12, fontWeight: 700, color: active ? "var(--nectarine-11)" : "var(--text-1)", margin: 0 }}>{c.label}</p>
