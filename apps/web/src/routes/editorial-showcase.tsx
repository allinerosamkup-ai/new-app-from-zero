...
export const EditorialShowcase: React.FC = () => {
  return (
    <div className="editorial-showcase" style={{ padding: '40px 20px 80px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '60px', minHeight: '100vh' }}>
        ...
        <PhoneFrame label="Com check-in">
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
              ...
              <div style={{ textAlign: 'center', flex: 1 }}>
                <span style={{ fontSize: '11px', fontWeight: 800, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--accent-peach-ink)' }}>Energia Radiante</span>
              </div>
              <div style={{ background: 'var(--accent-peach-a3)', color: 'var(--accent-peach-ink)', padding: '4px 8px', borderRadius: '999px', fontSize: '10px', fontWeight: 700 }}>MODERADO</div>
            </div>
            <p style={{ fontSize: '12.5px', lineHeight: 1.6, color: 'var(--accent-peach-ink)', opacity: .85, textAlign: 'center', marginBottom: '10px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', justifyContent: 'center' }}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="var(--accent-peach-strong)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
              <span style={{ fontSize: '11.5px', fontStyle: 'italic', color: 'var(--accent-peach-ink)' }}>Aproveite o pico para suas tarefas mais importantes antes das 14h.</span>
            </div>
          </div>
          ...
          <div className="mini-chart-area">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="var(--accent-sage)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '9px', color: 'var(--text-3)' }}>
                  <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: 'var(--accent-sage)' }}></span>Humor
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '9px', color: 'var(--text-3)' }}>
                  <span style={{ width: '10px', height: '2px', background: 'var(--accent-sage)', opacity: .6, display: 'inline-block', borderTop: '2px dashed var(--accent-sage)' }}></span>Energia
                </div>
              </div>
            </div>
            ...
            <svg width="100%" viewBox="0 0 280 72" style={{ overflow: 'visible' }}>
              ...
              <path d="M16 52 C50 52 60 20 80 24 C100 28 110 38 140 32 C170 26 190 18 220 20 C240 21 256 28 264 24" fill="none" stroke="var(--accent-sage)" strokeWidth="2.5" strokeLinecap="round"/>
              ...
              <defs>
                <linearGradient id="moodg_home" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="var(--accent-sage)" stopOpacity=".25"/>
          ...
          <div className="shortcut-grid">
            <div className="shortcut-card">
              <div style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'var(--accent-peach-a3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--accent-peach)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
              </div>
            ...
            <div className="shortcut-card">
              <div style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'rgba(180,185,169,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--accent-sage)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
              </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
            ...
            <AuraButtonV2 style={{ fontSize: '12px', fontWeight: 600, color: 'var(--accent-peach)', display: 'flex', alignItems: 'center', gap: '3px', background: 'none', border: 'none', cursor: 'pointer' }}>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '3px' }}>
              ...
              <span style={{ color: 'var(--accent-peach)', fontSize: '14px' }}>→</span>
            </div>
            ...
            <div style={{ textAlign: 'center', marginTop: '6px' }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', height: '22px', padding: '0 8px', borderRadius: '999px', fontSize: '10px', fontWeight: 700, letterSpacing: '.06em', textTransform: 'uppercase', background: 'rgba(176,180,196,.12)', color: '#4A7A8E', border: '1px solid rgba(176,180,196,.2)' }}>
                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--accent-sky)' }}></span>
                TRABALHO
              </div>
            </div>
          </div>
