...
const AuraPreviewBridgePlugin = () => {
    ...
    return (
        <div className="fixed right-4 top-1/4 z-[100] flex items-start gap-4">
            ...
            {isOpen && (
                <div className="w-64 bg-white/95 backdrop-blur-md border border-[#E7F0EA] rounded-2xl p-4 shadow-2xl animate-in slide-in-from-right fade-in duration-300">
                    <div className="flex items-center justify-between mb-4 pb-2 border-b border-[#E7F0EA]/50">
                    ...
                    <div className="space-y-3">
                        {/* Status ConnectPro */}
                        <div className="bg-[#E7F0EA]/30 p-3 rounded-xl border border-[#E7F0EA]/50">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <button className="flex flex-col items-center justify-center p-3 h-16 bg-[#E7F0EA]/10 hover:bg-[#E7F0EA]/30 border border-[#E7F0EA]/30 rounded-xl transition-all group">
                        ...
                        <div className="p-2 border border-dashed border-[#E7F0EA] rounded-lg">
            ...
            <button
                ...
                className={`w-12 h-12 flex items-center justify-center rounded-full shadow-lg transition-all duration-300 ${
                    isOpen ? 'bg-orange-600 rotate-90 scale-110' : 'bg-white hover:bg-[#E7F0EA]/50 border-2 border-[#E7F0EA] active:scale-90 hover:shadow-orange-100'
                }`}
