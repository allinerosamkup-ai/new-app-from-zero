...
| `.worktrees/onboarding-stripe-partners` | `codex/onboarding-stripe-partners` / `afc898d` | `ACTIVE` | Codex: Tasks 1–3 concluídas; seguir pelas Tasks 4–5 (oferta final e redirecionamento legado) |
